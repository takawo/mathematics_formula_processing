...
public class sketch_026 extends PApplet {

/*  mathematics formula */
//  inspired https://twitter.com/ru_sack/status/781981002558115840
//
// x=(cos(5u)*cos(v))^3
// y=(sin(3u)*cos(v))^3
// z=sin(v)^3
...
public void setup() {
  ...
  bgColor = color(164, 100, 15);
  keyColor = color(140, 83, 50);
  baseColor = color(112, 42, 93);
...
public void draw() {
  ...
  for (float v = minV; v <= maxV; v += stepV) {
    for (float u = minU; u <= maxU; u += stepU) {
      float x = pow(cos(5 * u) * cos(v),3) * scale;
      float y = pow(sin(3 * u) * cos(v),3) * scale;
...
public void gifDraw(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "sketch_026" };
    if (passedArgs != null) {
